                ...
                <div className="h-dvh bg-gradient-to-bl from-white to-indigo-100">
                    ...
                    <div className="container mx-auto px-4 py-16 text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">
                            ResearchXcelerator Privacy Policy
                        </h1>
                        ...
                        <div className=''>
                            ...
                            <ul>
                                ...
                                <li><em>Mobile Device Access.</em> We may request access or permission to certain features from your mobile device, including your mobile device&rsquo;s bluetooth, calendar, camera, own, and other features. If you wish to change our access or permissions, you may do so in your device&rsquo;s settings.</li>
                                ...
                                <li><em>Push Notifications.</em> We may request to send you push notifications regarding your account or certain features of the application(s). If you wish to opt out from receiving these types of communications, you may turn them off in your device&rsquo;s settings.</li>
                            </ul>
                            ...
                            <p>Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: [https://researchxcelerator.com/info/cookies].</p>
                            ...
                            <p>[<strong>Information collected when you use our Facebook application(s).</strong> </p>
                            ...
                            <ul>
                                ...
                                <li><strong>To send you marketing and promotional communications.</strong> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see &ldquo;<em>WHAT ARE YOUR PRIVACY RIGHTS?</em>&rdquo; below).</li>
                                <li><strong>To deliver targeted advertising to you.</strong> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more. For more information see our Cookie Notice:&nbsp;[https://researchxcelerator.com/info/cookies].</li>
                            ...
                            <p>In legal terms, we are generally the &ldquo;data controller&rdquo; under European data protection laws of the personal information described in this privacy notice, since we determine the means and/or purposes of the data processing we perform. This privacy notice does not apply to the personal information we process as a &ldquo;data processor&rdquo; on behalf of our customers. In those situations, the customer that we provide services to and with whom we have entered into a data processing agreement is the &ldquo;data controller&rdquo; responsible for your personal information, and we merely process your information on their behalf in accordance with your instructions. If you want to know more about our customers&rsquo; privacy practices, you should read their privacy policies and direct any questions you have to them.</p>
                            ...
                            <ul>
                                ...
                                <li><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). To find out more about Google&rsquo;s Privacy Policy, please refer to this&nbsp;<a href="https://policies.google.com/privacy" target="_blank" rel="noopener">link</a>. We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes:&nbsp;[List of Information Collected], and other similar information. A full list of what we use information for can be found in this section and in the previous section titled &ldquo;<em>HOW DO WE PROCESS YOUR INFORMATION?</em>&rdquo;. [We obtain and store on your device (&lsquo;cache&rsquo;) your location for&nbsp;[#] months. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein and Norway) or the United Kingdom, please take a look at our Cookie Notice, which can be found at this link:&nbsp;[https://researchxcelerator.com/info/cookies].</li>
                            ...
                            <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice:&nbsp;[https://researchxcelerator.com/info/cookies].</p>
                            ...
                            <p>Our servers are located in&nbsp;[Countries where Server is Located]. If you are accessing our Services from outside&nbsp;[Countries where Server is Located], please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see &ldquo;<em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>&rdquo; above), in&nbsp;[Countries where Third-Party Servers are Located], and other countries.</p>
                            ...
                            <p>We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this notice will require us keeping your personal information for longer than&nbsp;[the period of time in which users have an account with us / [#] months past the termination of the user&rsquo;s account / [#] months past the start of the idle period of the user&rsquo;s account / other].</p>
                            ...
                            <p><strong><u>Withdrawing your consent:</u></strong> If we are relying on your consent to process your personal information, which may be express and/or implied consent depending on the applicable law, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided in the section &ldquo;<em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>&rdquo; below or updating your preferences.</p>
                            <p>However, please note that this will not affect the lawfulness of the processing before its withdrawal, nor when applicable law allows, will it affect the processing of your personal information conducted in reliance on lawful processing grounds other than consent.</p>
                            <p><strong><u>Opting out of marketing and promotional communications:</u></strong> You can unsubscribe from our marketing and promotional communications at any time by clicking on the unsubscribe link in the emails that we send, replying &ldquo;STOP&rdquo; or &ldquo;UNSUBSCRIBE&rdquo; to the SMS messages that we send,&nbsp;[Other] or by contacting us using the details provided in the section &ldquo;<em>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</em>&rdquo; below. You will then be removed from the marketing lists &mdash; however, we may still communicate with you, for example to send you service-related messages that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes.</p>
                            ...
                            <p>If you have questions or comments about your privacy rights, you may email us at&nbsp;[Email Address].</p>
                            ...
                            <p>If this definition of &ldquo;resident&rdquo; applies to you, we must adhere to certain rights and obligations regarding your personal information.</p>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Account login information, drivers&rsquo; licenses, health data, precise geolocation, racial or ethnic origin, religious or philosophical beliefs, and sex life or sexual orientation</td>
                                        <td>[NO/NO]</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <ul>
                                <li>Category A &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category B &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category C &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category D &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category E &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category F &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category G &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category H &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category I &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category J &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category K &ndash;&nbsp;[1 YEAR]</li>
                                <li>Category L &ndash;&nbsp;[1 YEAR]</li>
                            </ul>
                            ...
                            <p>[Company Name] collects and shares your personal information through:</p>
                            <ul>
                            ...
                            <p>You may contact us by email at&nbsp;[callum.dtait@gmail.com], by calling toll-free at&nbsp;[Phone Number], by visiting&nbsp;[Contact Form URL], or by referring to the contact details at the bottom of this document.</p>
                            ...
                            <p>[Company Name] has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:</p>
                            <ul>
                                ...
                                <li>Category K. Inferences drawn from any of the personal information listed above to create a profile or summary about, for example, an individual&rsquo;s preferences and characteristics.</li>
                                <li>Category L. Sensitive personal information, such as account login information, drivers&rsquo; licenses, health data, precise geolocation, racial or ethnic origin, religious or philosophical beliefs, and sex life or sexual orientation.</li>
                            </ul>
                            <p>The categories of third parties to whom we disclosed personal information for a business or commercial purpose can be found under &ldquo;<em>WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</em>&ldquo;.</p>
                            <p>[[Company Name] has not sold or shared any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. / [Company Name] has sold or shared the following categories of personal information to third parties in the preceding twelve (12) months:</p>
                            <ul>
                                <li>Category A. Identifiers, such as contact details, like your real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name.</li>
                                <li>Category B. Personal information, as defined in the California Customer Records law, such as your name, contact information, education, employment, employment history, and financial information.</li>
                                <li>Category C. Characteristics of protected classifications under California or federal law, such as gender or date of birth.</li>
                            ...
                            <p>[We do not process consumer&rsquo;s sensitive personal information. / If the business collects any of the following:</p>
                            <p>&nbsp;</p>
                            <ul>
                                <li>social security information, drivers&rsquo; licenses, state ID cards, passport numbers</li>
                            ...
                            <p>To exercise your right to limit use and disclosure of sensitive personal Information, please email [callum.dtait@gmail.com] or visit: [DSAR Form URL].]</p>
                            ...
                            <p>To exercise these rights, you can contact us by email at&nbsp;[callum.dtait@gmail.com], by calling toll-free at&nbsp;[Phone Number], by visiting&nbsp;[Contact Form URL], or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
                            <p><strong>Financial Incentives</strong></p>
                            <p>&ldquo;Financial incentive&rdquo; means a program, benefit, or other offering, including payments to consumers as compensation, for the disclosure, deletion, sharing, or sale of personal information.</p>
                            <p>The law permits financial incentives or a price or service difference if it is reasonably related to the value of the consumer&rsquo;s data. A business must be able to explain how the financial incentive or price or service difference is reasonably related to the value of the consumer&rsquo;s data. The explanation must include:</p>
                            <ul>
                                <li></li>
                                <li></li>
                                <li>a good-faith estimate of the value of the consumer&rsquo;s data that forms the basis for offering the financial incentive or price or service difference; and</li>
                                <li>a description of the method the business used to calculate the value of the consumer&rsquo;s data.</li>
                            </ul>
                            <p>We may decide to offer a financial incentive (e.g., price or service difference) in exchange for the retention, sale or sharing of a consumer&rsquo;s personal information.</p>
                            ...
                            <p>&ldquo;Consumer&rdquo; means a natural person who is a resident of the Commonwealth acting only in an individual or household context. It does not include a natural person acting in a commercial or employment context.</p>
                            ...
                            <p>You may contact us by email at&nbsp;[callum.dtait@gmail.com], by visiting&nbsp;[Contact Form URL], or by referring to the contact details at the bottom of this document.</p>
                            ...
                            <p>We may request that you provide additional information reasonably necessary to verify you and your consumer&rsquo;s request. If you submit the request through an authorized agent, we may need to collect additional information to verify your identity before processing your request.</p>
